...
export const promotionStatusLabel: Record<PromotionStatus, string> = {
  ...
  APPROVED: 'Approved',
  PUBLISHER_ASSIGNED: 'Ready to post',
...
> = {
  ...
  APPROVED: ['PUBLISHING_IN_PROGRESS', 'CANCELLED'],
  PUBLISHER_ASSIGNED: ['PUBLISHING_IN_PROGRESS', 'CANCELLED'],
  PUBLISHING_IN_PROGRESS: ['READY_FOR_INVOICING', 'CANCELLED'],
  PUBLISHED: ['READY_FOR_INVOICING', 'CANCELLED'],
  VERIFICATION_PENDING: ['READY_FOR_INVOICING', 'CANCELLED'],
