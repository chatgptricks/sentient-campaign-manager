...
const profiles: Profile[] = [
  ...
  },
  {
    ...
    email: 'esteban@sentientagency.io',
    displayName: 'Esteban',
    status: 'ACTIVE',
    roles: ['ADMINISTRATOR'],
    slackUserId: 'U08UYJMPJ76',
  },
  {
    id: 'e2222222-2222-4222-8222-222222222222',
    email: 'louis@sentientagency.io',
    displayName: 'Louis',
    status: 'ACTIVE',
    roles: ['ADMINISTRATOR'],
    slackUserId: 'U06DZPVNTBR',
  },
  {
    id: 'e3333333-3333-4333-8333-333333333333',
    email: 'ivan@sentientagency.io',
    displayName: 'Ivan',
    status: 'ACTIVE',
    roles: ['ADMINISTRATOR'],
    slackUserId: 'U0516SU09J9',
  },
  {
    id: 'e4444444-4444-4444-8444-444444444444',
    email: 'sergio@sentientagency.io',
    displayName: 'Sergio',
    status: 'ACTIVE',
    roles: ['SALES'],
    slackUserId: 'U087U6470M6',
  },
  {
    id: 'e5555555-5555-4555-8555-555555555555',
    email: 'victor@sentientagency.io',
    displayName: 'Victor',
    status: 'ACTIVE',
    roles: ['SALES'],
    slackUserId: 'U0BAJA1AC6P',
  },
  {
    id: 'e6666666-6666-4666-8666-666666666666',
    email: 'egor@sentientagency.io',
    displayName: 'Egor',
    status: 'ACTIVE',
    roles: ['SALES'],
    slackUserId: 'U081LU7PVK3',
  },
  {
    id: 'e7777777-7777-4777-8777-777777777777',
    email: 'santiagoflhi@gmail.com',
    displayName: 'Santiago',
    status: 'ACTIVE',
    roles: ['CREATOR'],
    slackUserId: 'U0AGH0MJ3EH',
  },
  {
    id: 'e8888888-8888-4888-8888-888888888888',
    email: 'dsflorezl@gmail.com',
    displayName: 'Florez',
    status: 'ACTIVE',
    roles: ['CREATOR'],
    slackUserId: 'U0BH9R6EE4Q',
  },
  {
    id: 'e9999999-9999-4999-8999-999999999999',
    email: 'sara1107giraldo@gmail.com',
    displayName: 'Sara',
    status: 'ACTIVE',
    roles: ['CREATOR'],
    slackUserId: 'U0BGHD1HD0R',
  },
  {
    id: 'ea111111-1111-4111-8111-111111111111',
    email: 'sebastianruizurquijo@gmail.com',
    displayName: 'Sebastian',
    status: 'ACTIVE',
    roles: ['CREATOR'],
    slackUserId: 'U0BG04Q4Z8F',
  },
  {
    id: 'eb222222-2222-4222-8222-222222222222',
    email: 'tevi.mc12@gmail.com',
    displayName: 'Tevi',
    status: 'ACTIVE',
    roles: ['CREATOR'],
    slackUserId: 'U05QU9WCR1N',
  },
];
